...
const App = (): JSX.Element => {
  ...
  useEffect(() => {
    ...
    dispatch(
      newTask({
        playerID: "3", taskName: "Raw Chicken", taskType: "Cooking", amount: 1,
      }),
    );
    dispatch(
      newTask({
        playerID: "3", taskName: "Raw Chicken", taskType: "Cooking", amount: 2,
      }),
    );
    dispatch(
      newTask({
        playerID: "3", taskName: "Raw Chicken", taskType: "Cooking", amount: 3,
      }),
    );
    dispatch(
      newTask({
